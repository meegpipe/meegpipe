function [varargout]=mat2wfdb(x, fname, Fs, verbose, varargin)
%
...
params={'bit_res','adu','info','gain','sg_name','baseline','isint'};
param_offset=1;
adu=[];
info=[];
isint=0;
