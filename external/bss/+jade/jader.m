function [B,Vout] =  jader(X,m, whitFlag)
...
% NOTE: MODIFIED BY GERMAN GOMEZ HERRERO. ADDED PARAMTER WHITFLAG WHICH CAN
% BE USED TO PREVENT THIS FUNCTION TO PERFORM THE SPATIAL WHITENING, I.E.
% IF WHITFLAG=FALSE THEN THIS FUNCTION WILL ASSUMED THAT THE DATA HAS BEEN
% ALREADY PREWHITENED

% Copyright : Jean-Francois Cardoso.  cardoso@sig.enst.fr

% Added by GGH
if nargin < 3 || isempty(whitFlag), whitFlag = true; end
if nargin < 2 || isempty(m), m = size(X,1); end
% End of addition
