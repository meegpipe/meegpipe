...
target = 'https://github.com/germangh/meegpipe';
name   = 'meegpipe';
print_link(obj, target, name);

target = sprintf(...
    'https://github.com/germangh/meegpipe/commit/%s', gitMaster);
name   = gitMaster;
print_link(obj, target, name);
...
if isempty(get_parent(obj)),
    ...
    code = [code ...
        ...
        sprintf('submodule_checkout(''%s'');', get_vers_file(obj.Node_)), ...
