...
if numel(varargin) > 1 && islogical(varargin{1}),
    ...
    % For backwards compatibility purposes. Before, the user could specify
    % whether set() should generate an error when attempting to set a
