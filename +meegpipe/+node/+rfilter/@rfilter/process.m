...
for segItr = 1:numel(evSample)
    ...
    select(targetSel, data); %%%%%%%%%%%%%%%%%%%%%%%%%%% TargetSel
    select(data, 1:size(data,1), first:last); %%%%%%%%%%%%%%%%%%%%   WinSel
    if ~isempty(pca),
        if verbose,
    ...
    pcs = filter(filtObj, pcs, regressors);
    ...
    restore_selection(data); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% WinSel
    restore_selection(data); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% TargetSel
