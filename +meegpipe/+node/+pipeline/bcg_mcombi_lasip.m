function obj = bcg_mcombi_lasip(sr, varargin)
% BCG_MCOMBI_LASIP - Pipeline for BCG correction using multicombi and LASIP
% filtering
%
% ## Usage synopsis:
%
% import meegpipe.node.pipeline.bcg_mcombi_lasip;
% myPipe = bcg_mcombi_lasip(sr, 'key', value, ...);
