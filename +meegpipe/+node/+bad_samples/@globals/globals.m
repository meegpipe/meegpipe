classdef (Sealed) globals < dynamicprops
    ...
    % Documentation: pkg_bad_samples.txt
    ...
    methods (Access = protected)
        ...
        function obj = globals
            ...
            obj = meegpipe.node.bad_samples.globals.read_file(obj);
            
            if exist(obj.UserFile, 'file'),
                obj = meegpipe.node.bad_samples.globals.read_file(obj, obj.UserFile, false);
            end
    ...
    methods (Static)
        ...
        function value = get(varargin)     
            ...
            if isempty(localObj) || ~isvalid(localObj)
                localObj = meegpipe.node.bad_samples.globals;                
            end
            if nargin < 1,
                value = localObj;
        ...
        function value = set(varargin)
            ...
            localObj = meegpipe.node.bad_samples.globals.get;
            value = localObj;        
            if mod(nargin,2) > 0,
                ME = MException('globals:InvalidInputArg', ...
            ...
            elseif nargin == 2,
                ...
                cellfun(@(x, y) meegpipe.node.bad_samples.globals.set(x,y), varargin(1:2:end), ...
                    varargin(2:2:end));
            end    
