classdef decimate < meegpipe.node.abstract_node
    ...
    methods
        ...
        function str = whatfor(~)
            ...
            str = ['Nodes of class _decimate_ sub-sample the ' ...
                'input data without any anti-aliasing filtering.'];
    ...
    methods
        ...
        function obj = decimate(varargin)
