classdef (Sealed) globals < dynamicprops
    ...
    %
    % See also: runica, config
    
    % Documentation: pkg_runica.txt
    ...
    methods (Access = protected)
        ...
        function obj = globals
            ...
            obj = spt.bss.runica.globals.read_file(obj);
            
            if exist(obj.UserFile, 'file'),
                obj = spt.runica.globals.read_file(obj, obj.UserFile, false);
            end
    ...
    methods (Static)
        ...
        function value = get(varargin)     
            ...
            if isempty(localObj) || ~isvalid(localObj)
                localObj = spt.bss.runica.globals;                
            end
            if nargin < 1,
                value = localObj;
        ...
        function value = set(varargin)
            ...
            localObj = spt.runica.globals.get;
            value = localObj;        
            if mod(nargin,2) > 0,
                ME = MException('globals:InvalidInputArg', ...
            ...
            elseif nargin == 2,
                ...
                cellfun(@(x, y) spt.runica.globals.set(x,y), varargin(1:2:end), ...
                    varargin(2:2:end));
            end    
