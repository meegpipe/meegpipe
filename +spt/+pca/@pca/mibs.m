...
%
% [kopt, logpdk] = mibs(eigVal, n)
%
% [kopt, logpdk] = mibs(eigVal, n, 'alpha', alpha)
%
%
% Where
%
...
% 
% ALPHA is a prior parameter. Default: 0.01
%
%
% ## Notes:
%
% * This function implements the version of the MIBS criterion presented in
%   [2]. 
%
%
% 
...
%
%
% See also: spt.pca, spt.pca.mdl, spt.pca.aic, spt

% Documentation: class_spt_pca.txt
% Description: Minka's Bayesian Selection criterion
